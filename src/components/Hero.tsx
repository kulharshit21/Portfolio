      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center max-w-5xl mx-auto">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="reveal-item opacity-0 transition-opacity duration-1000 ease-out mb-8">
              <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto">
                ML Researcher | Full-Stack Developer | IEEE Published Author
              </p>
            </div>
            <div className="reveal-item opacity-0 transition-opacity duration-1000 ease-out flex flex-wrap gap-4 justify-center">
              ...
              <a
                ...
                aria-label="Download Harshit Kulkarni's resume (opens in new tab)"
                onClick={() => {
                  // Track resume download
                  if (typeof window !== 'undefined' && (window as any).gtag) {
                    (window as any).gtag('event', 'resume_download', {
                      'event_category': 'engagement',
                      'event_label': 'Resume Download - Hero Section'
                    });
                  }
                }}
              >
          ...
          <div className="mx-auto md:mx-0 w-56 h-56 md:w-72 md:h-72 rounded-full overflow-hidden border-4 border-blue-500 shadow-lg">
            <img
              src={HarshitPhoto}
              alt="Professional headshot of Harshit Kulkarni, a Computer Science student and ML researcher, wearing a white shirt and smiling confidently"
            ...
            <div className="space-y-6">
              <div>
                <p className="text-gray-300 mb-4">
                  Pre-final year Computer Science student with hands-on experience building web applications (React, Flask, PHP), working with databases (MySQL, PostgreSQL), and developing ML pipelines. Proven track record in Agile teams, delivering accessible, metric-driven solutions. Seeking to contribute to applied scientific computing and international research collaboration.
                </p>
                ...
                <div className="space-y-2 text-gray-300 mt-6">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <a href="mailto:hk0534@srmist.edu.in" className="text-blue-400 hover:underline">
                ...
                <div className="flex flex-wrap gap-3 mt-6">
                  <span className="text-xs text-gray-400 uppercase tracking-wider self-center mr-1">Languages:</span>
                  <span className="px-3 py-1 bg-slate-700/80 rounded-full text-sm text-gray-200">English <span className="text-blue-400">· Professional</span></span>
                  <span className="px-3 py-1 bg-slate-700/80 rounded-full text-sm text-gray-200">Kannada <span className="text-blue-400">· Native</span></span>
                  <span className="px-3 py-1 bg-slate-700/80 rounded-full text-sm text-gray-200">Hindi <span className="text-blue-400">· Professional</span></span>
                </div>
              </div>
