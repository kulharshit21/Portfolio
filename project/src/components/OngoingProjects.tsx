...
const ongoingProjects: OngoingProject[] = [
  {
    id: 1,
    title: "Smart Health Device Patent",
    description: "Currently in the research and development phase of an innovative smart health monitoring device. Patent application preparation in progress.",
    status: "Research & Development"
  },
  {
    id: 2,
    title: "Research on Brain Sleep Disorders",
    description: "Conducting research on brain sleep disorders with guidance from an overseas mentor.",
    status: "Research In Progress"
  },
  {
    id: 3,
    title: "AI-Based Personalized Learning Web App",
    description: "Developing a web application that leverages AI to analyze individual learning content and generate customized study materials flashcards, quizzes, notes, and more.",
