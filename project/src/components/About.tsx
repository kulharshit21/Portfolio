            ...
            <div className="flex flex-col sm:flex-row gap-8 items-center">
              ...
              <div className="flex-1">
                ...
                <p className="text-slate-600 mb-4">
                  Dynamic student adapt in teamwork and independent projects, combining a strong work ethic with exceptional organizational skills. Proven ability in leveraging advanced user knowledge in IT and social media to enhance productivity. Thrives in data-driven environments and aspires to contribute to innovative projects.
                </p>
